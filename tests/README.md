...
uv run pytest tests/ --cov=feed_reader --cov-report=term --cov-report=html
...
uv run pytest tests/ --cov=feed_reader --cov-report=html
...
import pytest
from feed_reader.tools.my_tools import my_new_tool
...
uv run pytest tests/ --cov=feed_reader --cov-fail-under=40

# Generate coverage report for CI artifacts
uv run pytest tests/ --cov=feed_reader --cov-report=xml
```
...
4. Check coverage hasn't decreased: `uv run pytest tests/ --cov=feed_reader`
