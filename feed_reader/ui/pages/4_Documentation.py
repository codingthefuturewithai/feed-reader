"""Documentation viewer page for feed_reader Admin UI
...
def render_documentation_content():
    ...
    st.markdown("""
    This MCP server was generated from the feed_reader Cookie Cutter template.
    
    **Getting Started:**
    1. Test your server with MCP Inspector: `mcp dev feed_reader/server/app.py`
    2. Run the example client: `feed_reader-client "Hello World"`
...
def main():
    ...
    # Page header
    st.title("📖 feed_reader Documentation")
