"""Home/Dashboard page for feed_reader Admin UI
...
def render_project_overview():
    ...
    with col1:
        ...
        **Project Details:**
        - **Name:** feed_reader
        - **Description:** MCP server for RSS feed management with read/unread tracking
        - **Author:** Tim Kitchens
...
def render_system_info():
    ...
    with st.expander("🔍 System Information"):
        try:
            from feed_reader.ui.lib.utils import get_system_paths
...
def main():
    """Main page content"""
    # Page header
    st.title("🏠 feed_reader Admin Dashboard")
    ...
    # Footer
    st.markdown("---")
    st.caption(f"feed_reader Admin UI • Generated with SAAGA MCP Server Cookie Cutter")
