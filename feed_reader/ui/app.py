"""Streamlit Admin UI for feed_reader
...
Run with: streamlit run feed_reader/ui/app.py
"""
...
try:
    from feed_reader.ui.lib.components import render_header, render_sidebar, render_error_message
    from feed_reader.ui.lib.styles import apply_custom_styles, hide_streamlit_style
    from feed_reader.ui.lib.utils import get_project_info
    ...
    def get_project_info():
        return {"name": "feed_reader", "version": "0.1.0"}

# Page configuration
st.set_page_config(
    page_title="feed_reader Admin",
    page_icon="🛠️",
    layout="wide",
...
def main():
    ...
    try:
        ...
        st.markdown("## Welcome to feed_reader Admin Interface")
