"""Configuration management for feed_reader
...
class ServerConfig:
    ...
    def __post_init__(self):
        ...
        if self.config_dir is None:
            self.config_dir = Path(platformdirs.user_config_dir("feed_reader"))
        if self.data_dir is None:
            self.data_dir = Path(platformdirs.user_data_dir("feed_reader"))
        if self.log_dir is None:
            self.log_dir = Path(platformdirs.user_log_dir("feed_reader"))
        ...
        self.log_file_path = self.log_dir / "feed_reader.log"
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "ServerConfig":
        ...
        if "server" in data:
            ...
            return cls(
                name=server_config.get("name", "feed_reader"),
            ...
            return cls(
                name=data.get("name", "feed_reader"),
...
def get_platform_info() -> Dict[str, str]:
    ...
    return {
        "config_dir": str(platformdirs.user_config_dir("feed_reader")),
        "data_dir": str(platformdirs.user_data_dir("feed_reader")),
        "log_dir": str(platformdirs.user_log_dir("feed_reader")),
        "cache_dir": str(platformdirs.user_cache_dir("feed_reader")),
    }
