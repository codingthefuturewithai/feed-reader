"""Logging configuration for feed_reader MCP server"""
...
def setup_logging(server_config: Optional[ServerConfig] = None) -> None:
    """Configure logging for the feed_reader MCP server"""
    ...
    project_logger = logging.getLogger("feed_reader")
    ...
    log_file = log_path / "feed_reader.log"
